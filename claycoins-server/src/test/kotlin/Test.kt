...
class ServerTest {
    ...
    fun testPostUser() = testApplication {
        ...
        println(newToken)
        client.webSocket {
            send(Json.encodeToString(MessageContainer(newToken, "content")))
        }
//        coroutineScope {
//            launch {
//                for (token in tokens) {
//                    client.post("/chat") {
//                        body(MessageContainer(token, "hello from \"hello\""))
//                    }
//                    delay(250)
//                }
//            }
...
//            }
//        }
//        val chat = client.get("/chat").json<List<ChatMessage>>()
//        println(chat)
    }
}